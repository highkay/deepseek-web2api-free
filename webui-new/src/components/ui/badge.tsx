  ...
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        idle: 'border-transparent bg-success/15 text-success',
        busy: 'border-transparent bg-primary/15 text-primary',
        error: 'border-transparent bg-warning/15 text-warning',
        env: 'border-transparent bg-muted text-muted-foreground',
      },
    },
